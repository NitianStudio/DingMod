...
public class TranslateKeyRegistry {
    ...
    public static final MutableComponent amaze = Component.translatable("ding.amaze");
    public static final MutableComponent amazeDesc = Component.translatable("ding.amaze.desc");
}
