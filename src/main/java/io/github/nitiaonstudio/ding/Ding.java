...
import static io.github.nitiaonstudio.ding.registry.Renders.*;
...
public class Ding {
    ...
    public Ding(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Ding) to respond directly to events.
