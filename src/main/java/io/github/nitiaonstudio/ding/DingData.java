...
public class DingData {
    ...
    public static void data(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new DingLanguageProvider(packOutput, MODID)
                ...
                .add(TranslateKeyRegistry.amaze, "Surpassing the power of nature")
                .add(TranslateKeyRegistry.amazeDesc, "Oh my God, this is not gonna happen")
                ...
                .add(TranslateKeyRegistry.amaze, "超越自然的伟力")
                .add(TranslateKeyRegistry.amazeDesc, "噢我的上帝，这不可能实现的")
