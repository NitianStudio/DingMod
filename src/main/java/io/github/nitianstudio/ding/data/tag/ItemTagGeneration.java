...
public class ItemTagGeneration extends ItemTagsProvider implements Const {
    ...
    public ItemTagGeneration(GatherDataEvent event, BlockTagGeneration btg) {
        super(event.getGenerator().getPackOutput(), event.getLookupProvider(), btg.contentsGetter(), MODID, event.getExistingFileHelper());
    }
